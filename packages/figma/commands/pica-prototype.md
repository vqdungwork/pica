...
Load `${CLAUDE_PLUGIN_ROOT}/rules/figma-screens.md` and the html package's
`${CLAUDE_PLUGIN_ROOT}/../html/rules/html-gates.md` for the behaviour-review checklist below, then load
