...
**Load first:** `roles/design-researcher/rules/design-vocabulary.md` and `roles/design-researcher/rules/research.md`.

**Load first, in this order:**

1. `roles/design-researcher/rules/research.md`: sources, provenance, what counts as evidence
2. `roles/design-researcher/rules/design-vocabulary.md`: the nine foundations, and typography by role
...
```json
"estimate": { "research": { "o": 0, "m": 0, "p": 0, "by": "pica-design-researcher" } }
```
