...
1. `roles/business-analyst/rules/business-analysis.md`: the four beats: elicit, analyse, specify, validate
2. `roles/business-analyst/rules/domain-knowledge.md`: where constraints live, in order of authority
3. `roles/business-analyst/rules/industry-knowledge.md`: how to use the sector base
...
```json
"estimate": { "analysis": { "o": 0, "m": 0, "p": 0, "by": "pica-business-analyst" } }
```
