...
```bash
node roles/business-analyst/scripts/industry-check.mjs --list
node roles/business-analyst/scripts/industry-check.mjs --show education
node roles/business-analyst/scripts/industry-check.mjs --audit     # the base against itself
```
...
The base is `roles/business-analyst/data/industries.json`. A new sector needs every field the others carry, and
