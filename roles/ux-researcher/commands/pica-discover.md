...
Spawn `pica-ux-researcher` **one per segment**, and none of them sees another's findings before
...
claim, and a source. **The design surface belongs to `pica-design-researcher`; this is the commercial
half.**
