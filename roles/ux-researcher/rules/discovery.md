...
`pica-design-researcher` measures the design surface of shipped competitors. That is real research and
...
`pica-design-researcher` measures a competitor's radius and control height. **What it charges and how
