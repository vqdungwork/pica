 ...
 * The matrix was prose in the design phase, worked out by whoever was drawing. Now pica-systems-analyst
...
if (!modelStates.size) {
  ...
  console.log("                pica-systems-analyst produces it in analysis. This is an abstention, not a pass.");
  process.exit(0);
}
