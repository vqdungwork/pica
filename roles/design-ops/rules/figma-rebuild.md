...
live in `core/rules/reference-discipline.md`. Read that first. This file
...
The port's gates are in `roles/design-ops/rules/figma-gates.md`; a rebuild replaces several of them and
